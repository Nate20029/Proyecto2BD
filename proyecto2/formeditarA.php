...
$anuncios=$db->query("SELECT * FROM Anuncios WHERE id=$id")->fetchAll(PDO::FETCH_OBJ);
$anuncio=$anuncios[0];
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <form action="funeditarA.php" method="post" class="form-horizontal">
                ...
                <div class="col-sm-10">
                    <input value="<?php echo $anuncio->id; ?>" name='id' type="text" class="form-control" placeholder="Escriba el código" readonly>
                </div>
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">NOMBRE DEL ANUNCIO</label>
                <div class="col-sm-10">
                    <input value="<?php echo $anuncio->nombre_anuncio; ?>" name="nombre_anuncio" type="text" class="form-control" placeholder="Escriba el nombre en MAYUSCULA">
                </div>
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">LINK</label>
                <div class="col-sm-10">
                    <input value="<?php echo $anuncio->link; ?>" name="link" type="text" class="form-control" placeholder="Pegue el link del anuncio">
                </div>
                </div>
                <div class="form-group">

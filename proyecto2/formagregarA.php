...
$filas=$db->query("SELECT * FROM Anuncios ")->fetchAll(PDO::FETCH_OBJ)?>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <form action="funagregarA.php" method="post" class="form-horizontal">
                ...
                <label class="col-sm-2 control-label">NOMBRE DE ANUNCIO</label>
                <div class="col-sm-10">
                    <input name='nombre_anuncio' type="text" class="form-control" placeholder="Escriba el nombre en MAYUSCULA">
                </div>
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">LINK</label>
                <div class="col-sm-10">
                    <input name="link" type="text" class="form-control" placeholder="Pegue el link del anuncio">
                </div>
                </div>
                <div class="form-group">

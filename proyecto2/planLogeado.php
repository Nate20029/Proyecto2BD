    ...
    <main>
        ...
        <section class="price container">
            ...
            <div class="price__table">
                ...
                <form action = "cambiarPlan.php" class="formulario__register" method = "post">
                    ...
                    <input type="submit" name = "free" class="price__cta" value="Empieza ahora">
                </form>
                </div>
                ...
                <form action = "cambiarPlan.php" class="formulario__register" method = "post">
                    <div class="price__element price__element--best">
                        ...
                        <input type="submit" name = "plan1" class="price__cta" value="Empieza ahora">
                    </div>
                </form>
                ...
                <form action = "cambiarPlan.php" class="formulario__register" method = "post">
                    <div class="price__element">
                        ...
                        <input type="submit" name = "plan2" class="price__cta" value="Empieza ahora">
                    </div>
                </form>

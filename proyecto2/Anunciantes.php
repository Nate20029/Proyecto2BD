...
$filas=$db->query("SELECT * FROM Anunciantes ORDER BY id ASC ")->fetchAll(PDO::FETCH_OBJ)?>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <table class="table table-hover">
                <thead><th>ID</th><th>NOMBRE ANUNCIANTES</th><th>CORREO ANUNCIANTE</th><th>TELEFONO</th>
                </thead>
                <tbody>
